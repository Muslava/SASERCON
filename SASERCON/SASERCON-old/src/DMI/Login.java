    ...
    private void Acceder()  {
            ...
            try {
                ...
                if(find == 1)    {
                    ...
                    if(rs.next()==true)    {
                        ...
                        if(rs.getString("contrasena").length()<8)    {
                            this.lblLcontra.setForeground(red);
                            this.lblLipassword.setIcon((Icon) new ImageIcon(getClass().getResource("../img/LogIn/icons8_key_30px_1.png")));
                            this.lblLcorreo.setForeground(new java.awt.Color(120, 121, 124));
                            this.lblLiusuario.setIcon((Icon) new ImageIcon(getClass().getResource("../img/LogIn/icons8_user_filled_30px.png")));
        ...
        if(txtLcorreo.getText().trim().isEmpty() && psfLcontra.getText().trim().isEmpty()) {
            ...
            try {
                ...
                ResultSet rs0 = st.executeQuery("SELECT correoEmpleado FROM tbl_empleado;");
                while(rs0.next()) {
                    System.out.println(rs0.getString("correoEmpleado"));
                    count++;
                    if(Lcorreo.equals(ALERTA.getDecrypted(rs0.getString("correoEmpleado"))))    {
                        find = 1;
                        matrif = count;
                ...
                if(find == 1)    {
                    ...
                    if(rs.next()!=false)    {
                        ...
                        if(rs.getString("contrasena")==null)    {
                            ...
                            ps = con.prepareStatement("SELECT contrasena, puesto, matricula FROM tbl_empleado WHERE matricula = "+matrif+" AND estadoActivo = 1;");
                            rs = ps.executeQuery();
