...
public int X1, Y1;
public int find = 0, count = 0, matrif = 0;
Comprobacion ALERTA = new Comprobacion();
    ...
    private void initComponents() {
        ...
        lblLcerrar1.setIcon(new ImageIcon(this.getClass().getResource("/img/LogIn/icons8_close_window_24px_3.png"))); // NOI18N
        ...
        //Image img = Toolkit.getDefaultToolkit().createImage("/img/LogIn/LOGOf.png");
        //this.lblLlogo.setIcon(new ImageIcon(img.getScaledInstance(190, 190, Image.SCALE_DEFAULT)));
        //this.lblLlogo.setIcon((Icon) new ImageIcon(getClass().getResource("/img/LogIn/LOGOf.png")).getImage().getScaledInstance(190, 190, Image.SCALE_DEFAULT));
        this.lblLlogo.setIcon(new ImageIcon(getClass().getResource("/img/LogIn/LOGOf.png")));
        ...
        lblLiusuario.setIcon(new javax.swing.ImageIcon(this.getClass().getResource("/img/LogIn/icons8_user_filled_30px.png"))); // NOI18N

        lblLipassword.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblLipassword.setIcon(new javax.swing.ImageIcon(this.getClass().getResource("/img/LogIn/icons8_key_30px.png"))); // NOI18N
    ...
    private void lblLcerrar1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLcerrar1MouseEntered
        lblLcerrar1.setIcon(new ImageIcon(getClass().getResource("/img/LogIn/icons8_close_window_24px_6.png")));
    ...
    private void lblLcerrar1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblLcerrar1MouseExited
        lblLcerrar1.setIcon(new ImageIcon(getClass().getResource("/img/LogIn/icons8_close_window_24px_3.png")));
            ...
            if(Arrays.toString(psfLnueva_contra.getPassword()).length() >= 8) {
                if(Arrays.toString(psfLnueva_contra.getPassword()).equals(Arrays.toString(psfLconfirmar_contra.getPassword())))   {
                    ...
                    try {
                        ...
                        ps = con.prepareStatement("UPDATE tbl_empleado SET contrasena = '"+ALERTA.getSHA3(new String(psfLnueva_contra.getPassword()))+"' WHERE matricula = "+matrif+";");
                ...
                JOptionPane.showMessageDialog(null,"La contraseña no debe ser menor a 8 caracteres.","Contraseña demasiado corta",JOptionPane.WARNING_MESSAGE);
            }
        }
    }
    ...
    private void access()  {
        ...
        /*if(psfLcontra.getText().trim().isEmpty() && !txtLcorreo.getText().trim().isEmpty()) {
            ...
            PreparedStatement ps;
            try {
                URL url = new URL("https://9qob1rxodb.execute-api.us-west-1.amazonaws.com/api/employee");
                ...
                if (responsecode != 200) {
                    ...
                    StringBuilder inline = new StringBuilder("{\"Employees\": ");
                    //String inline = "";
                    ...
                    for (Object o : arr) {
                        ...
                        if (new_obj.get("correoEmpleado").equals(Lcorreo)) {
                            find = 1;
                            contra = (String) new_obj.get("contrasena");
                            matrif = (Integer) new_obj.get("matricula");
                            break;
                        }
                    }

                    // Se encontro el correo y la matricula
                    System.out.println(count + "/" + find + "/" + matrif);
                    if (find == 1) {
                            if(!contra.equals("")) {
                            ...
                            if(contra.length() < 8) {
                                ...
                                this.lblLcorreo.setForeground(new java.awt.Color(120, 121, 124));
                                this.lblLiusuario.setIcon((Icon) new ImageIcon(getClass().getResource("/img/LogIn/icons8_user_filled_30px.png")));
                                JOptionPane.showMessageDialog(null, "La contraseña es de más de 8 caracteres.");
                            }
                            if(contra.equals("")) {
            ...
            try {
                ...
                if (responsecode != 200) {
                    ...
                    for (Object o : arr) {
                        ...
                        if (new_obj.get("correoEmpleado").equals(Lcorreo)) {
                            find = 1;
                            Lcontra = (String) new_obj.get("contrasena");
                            Lmatricula = Integer.parseInt((String) new_obj.get("matricula"));
                            Lpuesto = Integer.parseInt((String) new_obj.get("puesto"));
                            break;
                        }
                    }

                    // Se encontro el correo y la matricula
                    System.out.println(Lpuesto + "/" + find + "/" + Lmatricula);
                    if (find == 1) {
                    // Comprueba si el correo está registrado
                        if (!Lcontra.equals("")) {
                            ...
                            if (Lcontra == null) {
                                ...
                                Lscontra = new String(psfLcontra.getPassword());
                                if (Lscontra.equals(Lcontra) && Lpuesto != 3) {
                                    ...
                                    if (!Lmail.equals(this.txtLcorreo.getText().trim()))
                                        Lmail = this.txtLcorreo.getText().trim();
